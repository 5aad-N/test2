            ...
            <div class="card-body">
              ...
              <div class="row">
                <div class="col-6">
                  ...
                  <div class="fw-bold">${{ itemsStore.currentItem.starting_price }}</div>
                </div>
                <div class="col-6">
                  <small class="text-muted">Current Price</small>
                  <div class="fw-bold text-success fs-4">
                    ${{ itemsStore.currentItem.current_price }}
                  </div>
                </div>
              </div>
...
const minBidAmount = computed(() => {
  ...
  const current = parseFloat(itemsStore.currentItem.current_price);
...
const handlePlaceBid = async () => {
  const success = await itemsStore.placeBid(itemId.value, String(bidAmount.value));
  if (success) {
    bidAmount.value = '';
